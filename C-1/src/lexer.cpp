                ...
                case 5:
                    if (*f_ptr == '\'' || *f_ptr == '\\' || *f_ptr == 'a' || *f_ptr == 'b' ||
                        *f_ptr == 'f' || *f_ptr == 'n' || *f_ptr == 'r' || *f_ptr == 't' || *f_ptr == 'v') {
                        ...
                        //error    
                        forward();
                        printf("Error: line:%2d, Invaild char after escape letter\n", m_cur_line);
                        state = 8;
                    }
                    break;
                case 6:
                    if ('0' <= *f_ptr && *f_ptr <= '9' || 'a' <= *f_ptr && *f_ptr <= 'f' ||
                        ...
                        //error    
                        forward();
                        printf("Error: line:%2d, Invaild hexcimal in character\n", m_cur_line);
                        state = 8;
                    }
                    break;
                case 7:
            ...
            do {
                ...
                case 2:
                    if (*f_ptr == '\'' || *f_ptr == '\"' || *f_ptr == '\\' || *f_ptr == 'a' || *f_ptr == 'b' ||
                        *f_ptr == 'f' || *f_ptr == 'n' || *f_ptr == 'r' || *f_ptr == 't' || *f_ptr == 'v') {
                        ...
                        forward();
                        printf("Error: line:%2d, invaild escape character in string.\n", m_cur_line);
                        state = 7;
                    }
                    break;
                case 3:
                    if ('0' <= *f_ptr && *f_ptr <= '7') {
                        ...
                        forward();
                        printf("Error: line:%2d, invaild octal format in string.\n", m_cur_line);
                        state = 7;
                    }
                    break;
                case 4:
                ...
                case 5:
                    if ('0' <= *f_ptr && *f_ptr <= '9' || 'a' <= *f_ptr && *f_ptr <= 'f' || 'A' <= *f_ptr && *f_ptr <= 'F') {
                        ...
                        forward();
                        printf("Error: line:%2d, invaild hexadecimal format in string.\n", m_cur_line);
                        state = 7;
                    }
                    break;
                case 6:
                ...
                do {
                    ...
                    case 0:
                        if (*f_ptr == '*') {
                            ...
                            printf("Error: comment don't self-close");
                            tkn = new Token(END_OF_FILE);
                            quit_loop = true;
                        }
                        break;
